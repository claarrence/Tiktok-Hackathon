...
Member E (Clarence) — Integration, Docs & Submission
  ...
  - Repo hygiene, README, Devpost draft (including two documented corrections to earlier confounded benchmark claims — see `devpost.md`), and final submission.