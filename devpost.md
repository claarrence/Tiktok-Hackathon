...
- **Reciprocal Rank Fusion was tried and reverted** (see the README's "Development History and Diagnosis") after tuning landed it at a statistical tie with the simpler raw-score route fusion while costing Boundary-scenario MRR — noted here so it isn't re-attempted from scratch without that context.
